...
function KitchenScreen() {
  ...
  return (
    <ScrollView style={{ flex: 1, backgroundColor: theme.colors.surfaceDark, padding: 12 }}>
      {kots.map((k) => (
...
const s = StyleSheet.create({
  ...
  loginWrap: { padding: 24, paddingTop: 60, backgroundColor: theme.colors.surfaceDark, minHeight: '100%' },
  logo: { fontSize: 32, fontWeight: 'bold', color: '#fff', letterSpacing: -0.5 },
  sub: { color: theme.colors.gray, marginBottom: 24, fontSize: 15 },
  label: { fontWeight: '600', marginBottom: 4, color: '#fff' },
  input: { backgroundColor: '#fff', borderRadius: 14, padding: 14, marginBottom: 12, borderWidth: 1, borderColor: '#E2E8F0' },
  btn: { backgroundColor: theme.colors.primary, borderRadius: 14, padding: 16, alignItems: 'center', marginTop: 8, shadowColor: theme.colors.primary, shadowOpacity: 0.4, shadowRadius: 8, elevation: 4 },
  btnText: { color: '#fff', fontWeight: '700', fontSize: 16 },
  btnOutline: { borderWidth: 2, borderColor: theme.colors.accent, borderRadius: 14, padding: 14, alignItems: 'center', marginTop: 8 },
  btnOutlineText: { color: theme.colors.accent, fontWeight: '600' },
  chip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 20, backgroundColor: 'rgba(255,255,255,0.15)', marginRight: 8 },
  chipActive: { backgroundColor: theme.colors.primary },
  chipText: { color: theme.colors.gray },
  chipTextActive: { color: '#fff', fontWeight: '600' },
  header: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', padding: 14, backgroundColor: theme.colors.surfaceDark },
  headerTitle: { color: '#fff', fontWeight: '600', fontSize: 14 },
  logout: { color: theme.colors.accent, fontWeight: '600' },
  tabBar: { flexDirection: 'row', backgroundColor: '#fff', borderTopWidth: 1, borderColor: '#E2E8F0', paddingBottom: 4 },
  tab: { flex: 1, alignItems: 'center', paddingVertical: 12 },
  tabText: { fontSize: 12, color: theme.colors.muted },
  tabActive: { color: theme.colors.primary, fontWeight: '700' },
  tableCard: { width: '47%', borderRadius: 16, padding: 16, borderWidth: 2 },
  available: { borderColor: theme.colors.success, backgroundColor: '#ECFDF5' },
  occupied: { borderColor: theme.colors.accent, backgroundColor: '#FFF1F2' },
  tableNum: { fontSize: 28, fontWeight: 'bold', color: theme.colors.ink },
  tableStatus: { textTransform: 'capitalize', marginVertical: 4, color: theme.colors.muted },
  smallBtn: { backgroundColor: theme.colors.primary, borderRadius: 10, padding: 10, marginTop: 6, alignItems: 'center' },
  smallBtnText: { color: '#fff', fontSize: 12, fontWeight: '600' },
  smallBtnOutline: { borderWidth: 1, borderColor: theme.colors.primary, borderRadius: 10, padding: 10, marginTop: 6, alignItems: 'center' },
  smallBtnOutlineText: { color: theme.colors.primary, fontSize: 12, fontWeight: '600' },
  kotCard: { backgroundColor: '#1E1B4B', borderRadius: 14, padding: 16, marginBottom: 10, borderLeftWidth: 4, borderLeftColor: theme.colors.accent },
  kotNum: { color: '#fff', fontSize: 20, fontWeight: 'bold' },
  kotMeta: { color: theme.colors.gray, marginVertical: 4 },
  orderCard: { backgroundColor: '#fff', borderRadius: 14, padding: 14, marginBottom: 8, borderWidth: 1, borderColor: '#E2E8F0' },
  orderNum: { fontWeight: 'bold', fontSize: 16, color: theme.colors.ink },
});
